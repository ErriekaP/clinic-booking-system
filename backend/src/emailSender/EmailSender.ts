...
export class EmailSender {
  ...
  getHtmlBody(emailDetails: {
    ...
    console.log(emailDetails.emailType);
    if (emailDetails.emailType === 'AppointmentConfirmation') {
      return `
      ...
      * {
      ...
      <p style="line-height: 140%;">This is a friendly reminder about your upcoming ${emailDetails.serviceName} appointment with Dr. ${emailDetails.doctorFirstName} ${emailDetails.doctorLastName} scheduled for:</p>
      <p style="line-height: 140%;"> </p>
    ...
    if (emailDetails.emailType === 'AppointmentCancellation') {
      return `<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        * {
        ...
        <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p dir="ltr" style="line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;">Appointment Cancellation</span></p>
          </div>
        ...
        <table id="u_content_text_3" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div class="v-text-align" style="font-size: 14px; line-height: 120%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 30px; line-height: 36px;">Cancelled: Appointment on ${emailDetails.date}</span></p>
        <p style="font-size: 14px; line-height: 120%;"> </p>
        <p style="font-size: 14px; line-height: 120%;"> </p>
          </div>
        ...
        <table id="u_content_text_6" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
            <p style="line-height: 140%;">Hi ${emailDetails.patientFirstName} ${emailDetails.patientMiddleName} ${emailDetails.patientLastName},</p>
        <p style="line-height: 140%;"> </p>
        <p style="line-height: 140%;">I regret to inform you that your upcoming ${emailDetails.serviceName} appointment scheduled for: 
        </p>
        <p style="line-height: 140%;"> </p>
        <p style="line-height: 140%;">Date: ${emailDetails.date} <br />Start Time: ${emailDetails.startTime}<br />End Time: ${emailDetails.endTime}</p>
        <p style="line-height: 140%;"> </p>
        <p style="line-height: 140%;">has been cancelled due to "${emailDetails.reasonforCancellation}".</p>
        <p style="line-height: 140%;"> </p>
        <p style="line-height: 140%;">Best regards,<br />Ateneo Clinic</p>
          </div>
    ...
    if (emailDetails.emailType === 'QueueBefore') {
      return `
      <!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
      <head>
      ...
      * {
      ...
      <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
          <p dir="ltr" style="line-height: 140%;"><span style="font-size: 26px; line-height: 36.4px;">Queue</span></p>
        </div>
      ...
      <table id="u_content_text_3" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 14px; line-height: 120%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 120%;"><span style="font-size: 30px; line-height: 36px;">Reminder: You're Next in the Queue</span></p>
      <p style="font-size: 14px; line-height: 120%;"> </p>
      <p style="font-size: 14px; line-height: 120%;"> </p>
        </div>
      ...
      <table id="u_content_text_6" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
          <p style="line-height: 140%;">Hi ${emailDetails.patientFirstName} ${emailDetails.patientMiddleName} ${emailDetails.patientLastName},</p>
      <p style="line-height: 140%;"> </p>
      <p style="line-height: 140%;">This is just a friendly reminder that you are next in the queue for ${emailDetails.serviceName}. We want to ensure you are aware and prepared for your upcoming appointment.
      </p>
      <p style="line-height: 140%;"> </p>
      <p style="line-height: 140%;">Please make sure to be ready and available when your turn comes up. If there are any changes in your schedule or if you need to reschedule, please let us know as soon as possible.
      </p>
      <p style="line-height: 140%;"> </p>
      <p style="line-height: 140%;">Thank you for your cooperation, and we look forward to assisting you soon!</p>
      <p style="line-height: 140%;"> </p>
      <p style="line-height: 140%;">Best regards,<br />Ateneo Clinic</p>
        </div>
