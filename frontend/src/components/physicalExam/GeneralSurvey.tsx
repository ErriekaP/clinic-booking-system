      ...
      <div className="flex-grow">
        ...
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div className="flex flex-col">
            <label htmlFor="bloodPressure" className="text-sm font-bold my-2">
              Blood Pressure:
            </label>
            <input
              id="bloodPressure"
          ...
          <div>
            ...
            <input
              ...
              className={`shadow appearance-none border rounded w-full py-2 pl-2 mt-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                hypertensionActivated ? "" : "cursor-not-allowed bg-gray-200"
              }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`shadow appearance-none border rounded w-full py-2 pl-2 mt-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                bronchialAsthmaActivated ? "" : "cursor-not-allowed bg-gray-200"
              }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`shadow appearance-none border rounded w-full py-2 pl-2 mt-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                heartDiseaseActivated ? "" : "cursor-not-allowed bg-gray-200"
              }`}
          ...
          <div>
            ...
            <label>
              <Flex gap="2">
                ...
                >
                  <input type="checkbox" onChange={handleLOCCheckboxChange} />
                </div>
              </Flex>
            </label>
            <input
              ...
              onChange={handleInputChange}
              className={`shadow appearance-none border rounded w-full py-2 pl-2 mt-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                seizureDisorderActivated ? "" : "cursor-not-allowed bg-gray-200"
              }`}
