...
const ThemePanelImpl = React.forwardRef((props, forwardedRef) => {
    ...
    const themeContext = (0, index_1.useThemeContext)();
    ...
    const handleAppearanceChangeProp = (0, react_use_callback_ref_1.useCallbackRef)(onAppearanceChangeProp);
    const handleAppearanceChange = React.useCallback((appearance) => {
        ...
        if (hasOnAppearanceChangeProp) {
            ...
            (0, index_1.updateThemeAppearanceClass)(appearance);
        }
        cleanup();
    }, [onAppearanceChange, hasOnAppearanceChangeProp, handleAppearanceChangeProp]);
    const autoMatchedGray = (0, index_1.getMatchingGrayColor)(accentColor);
    const resolvedGrayColor = grayColor === 'auto' ? autoMatchedGray : grayColor;
    const [copyState, setCopyState] = React.useState('idle');
    async function handleCopyThemeConfig() {
        const theme = {
            appearance: appearance === index_1.themePropDefs.appearance.default ? undefined : appearance,
            accentColor: accentColor === index_1.themePropDefs.accentColor.default ? undefined : accentColor,
            grayColor: grayColor === index_1.themePropDefs.grayColor.default ? undefined : grayColor,
            panelBackground: panelBackground === index_1.themePropDefs.panelBackground.default ? undefined : panelBackground,
            radius: radius === index_1.themePropDefs.radius.default ? undefined : radius,
            scaling: scaling === index_1.themePropDefs.scaling.default ? undefined : scaling,
        };
    ...
    return (React.createElement(index_1.Theme, { asChild: true, radius: "medium", scaling: "100%" },
        React.createElement(index_1.Flex, { direction: "column", position: "fixed", top: "0", right: "0", mr: "4", mt: "4", 
            // @ts-ignore
            ...
            React.createElement(index_1.ScrollArea, null,
                React.createElement(index_1.Box, { grow: "1", p: "5", position: "relative" },
                    React.createElement(index_1.Box, { position: "absolute", top: "0", right: "0", m: "2" },
                        React.createElement(index_1.Tooltip, { content: "Press \u2318\u2009C to show/hide the Theme Panel", side: "bottom", sideOffset: 6 },
                            React.createElement(index_1.Kbd, { size: "3", tabIndex: 0, className: "rt-ThemePanelShortcut" }, "\u2318\u2009C"))),
                    React.createElement(index_1.Heading, { size: "5", trim: "both", as: "h3", mb: "5" }, "Theme"),
                    React.createElement(index_1.Text, { id: "accent-color-title", as: "p", size: "2", weight: "medium", mt: "5" }, "Accent color"),
                    React.createElement(index_1.Grid, { columns: "10", gap: "2", mt: "3", role: "group", "aria-labelledby": "accent-color-title" }, index_1.themeAccentColorsOrdered.map((color) => (React.createElement("label", { key: color, className: "rt-ThemePanelSwatch", style: { backgroundColor: `var(--${color}-9)` } },
                        React.createElement(index_1.Tooltip, { content: `${upperFirst(color)}${accentColor === 'gray' && resolvedGrayColor !== 'gray'
                    ...
                    React.createElement(index_1.Flex, { asChild: true, align: "center", justify: "between" },
                        React.createElement(index_1.Text, { as: "p", id: "gray-color-title", size: "2", weight: "medium", mt: "5" }, "Gray color")),
                    React.createElement(index_1.Grid, { columns: "10", gap: "2", mt: "3", role: "group", "aria-labelledby": "gray-color-title" }, ['auto', 'gray', ...index_1.radixGrayScalesDesaturated].map((gray) => (React.createElement(index_1.Flex, { key: gray, asChild: true, align: "center", justify: "center" },
                        React.createElement("label", { className: "rt-ThemePanelSwatch", style: {
                            ...
                            React.createElement(index_1.Tooltip, { content: `${upperFirst(gray)}${gray === 'auto' ? ` (${upperFirst(autoMatchedGray)})` : ''}` },
                    ...
                    React.createElement(index_1.Text, { id: "appearance-title", as: "p", size: "2", weight: "medium", mt: "5" }, "Appearance"),
                    React.createElement(index_1.Grid, { columns: "2", gap: "2", mt: "3", role: "group", "aria-labelledby": "appearance-title" }, ['light', 'dark'].map((value) => (React.createElement("label", { key: value, className: "rt-ThemePanelRadioCard" },
                        ...
                        React.createElement(index_1.Flex, { align: "center", justify: "center", height: "6", gap: "2" },
                            ...
                            React.createElement(index_1.Text, { size: "1", weight: "medium" }, upperFirst(value))))))),
                    React.createElement(index_1.Text, { id: "radius-title", as: "p", size: "2", weight: "medium", mt: "5" }, "Radius"),
                    React.createElement(index_1.Grid, { columns: "5", gap: "2", mt: "3", role: "group", "aria-labelledby": "radius-title" }, index_1.themePropDefs.radius.values.map((value) => (React.createElement(index_1.Flex, { key: value, direction: "column", align: "center" },
                        React.createElement("label", { className: "rt-ThemePanelRadioCard" },
                            ...
                            React.createElement(index_1.Theme, { asChild: true, radius: value },
                                React.createElement(index_1.Box, { m: "3", width: "6", height: "6", style: {
                        ...
                        React.createElement(index_1.Box, { asChild: true, pt: "2" },
                            React.createElement(index_1.Text, { asChild: true, size: "1", color: "gray" },
                                React.createElement("label", { htmlFor: `theme-panel-radius-${value}` }, upperFirst(value)))))))),
                    React.createElement(index_1.Text, { id: "scaling-title", as: "p", size: "2", weight: "medium", mt: "5" }, "Scaling"),
                    React.createElement(index_1.Grid, { columns: "5", gap: "2", mt: "3", role: "group", "aria-labelledby": "scaling-title" }, index_1.themePropDefs.scaling.values.map((value) => (React.createElement("label", { key: value, className: "rt-ThemePanelRadioCard" },
                        ...
                        React.createElement(index_1.Flex, { align: "center", justify: "center", height: "6" },
                            React.createElement(index_1.Theme, { asChild: true, scaling: value },
                                React.createElement(index_1.Flex, { align: "center", justify: "center" },
                                    React.createElement(index_1.Text, { size: "1", weight: "medium" }, upperFirst(value))))))))),
                    React.createElement(index_1.Flex, { mt: "5", align: "center", gap: "2" },
                        React.createElement(index_1.Text, { id: "panel-background-title", as: "p", size: "2", weight: "medium" }, "Panel background"),
                        React.createElement(index_1.Popover.Root, null,
                            React.createElement(index_1.Popover.Trigger, null,
                                React.createElement(index_1.IconButton, { size: "1", variant: "ghost", color: "gray" },
                                    React.createElement(index_1.AccessibleIcon, { label: "Learn more about panel background options" },
                                        React.createElement(icons_1.InfoCircledIcon, null)))),
                            React.createElement(index_1.Popover.Content, { size: "1", style: { maxWidth: 220 }, side: "top", align: "center" },
                                React.createElement(index_1.Text, { as: "p", size: "2" }, "Whether Card and Table panels are translucent, showing some of\u00A0the background behind them.")))),
                    React.createElement(index_1.Grid, { columns: "2", gap: "2", mt: "3", role: "group", "aria-labelledby": "panel-background-title" }, index_1.themePropDefs.panelBackground.values.map((value) => (React.createElement("label", { key: value, className: "rt-ThemePanelRadioCard" },
                        ...
                        React.createElement(index_1.Flex, { align: "center", justify: "center", height: "6", gap: "2" },
                            ...
                            React.createElement(index_1.Text, { size: "1", weight: "medium" }, upperFirst(value))))))),
                    React.createElement(index_1.Button, { mt: "5", style: { width: '100%' }, onClick: handleCopyThemeConfig }, copyState === 'copied' ? 'Copied' : 'Copy Theme'))))));
});
